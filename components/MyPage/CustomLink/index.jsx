...
const index = ({ payments, toggleResponse, business, profile }) => {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    if (
      (customLinks.length === 1 && customLinks[0].url === "")
    ) {
  ...
  return (
    <Grid container spacing={1} className={styles.custom_link_wrap}>
      <Grid item xs={12} sm={12} md={8}>        
        ...
        <div className={styles.profile_div}>
          <CustomLinks customLinks={customLinks} setCustomLinks={setCustomLinks} />
