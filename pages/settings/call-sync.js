        ...
        <div className="content-wrp">
          ...
          <div className="call-sync__wrp">
            ...
            <span className="btm__txt">
              <b>Two-way sync</b> - Add Linq appointments to your outside
              calendar and add events from your outside calendar to Linq,
              blocking off your availability.
              <br />
              <br />
              Appointments made in Linq should be edited in LInq; The system
              will not recognize changes made in outside calendars. Events
              synced into Linq from outside calendars must be edited in the
