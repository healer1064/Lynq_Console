    ...
    <>
      ...
      <div className="page-wrp">
        ...
        <div className="content-wrp">
          <Settings />
          <EventTypeEdit needsCount={needsCount} setNeedsCount={setNeedsCount} descriptionCount={descriptionCount} setDescriptionCount={setDescriptionCount} showActionsHandle={showActionsHandle} />
        </div>
      </div>
    </>
  )
